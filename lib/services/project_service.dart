...
class ProjectService {
  ...
  Future<String> editProject(
    ...
    http.Response res = await http.put(rootUrl + 'projects/' + id,
        body: jsonEncode({
          'title': title,
          'description': description,
          'users': users,
          'todos': encodeTask(tasks: tasks)
        }),
        headers: dataHeaders);
    return res.body;
  }
  ...
  Future<String> createProject(
      {title: String, description: String, users: String}) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    ...
    http.Response res = await http.post(rootUrl + 'projects/',
        body: jsonEncode({
          'title': title,
          'description': description,
          'users': users,
